  ...
  <footer class="footer bg-base-200 text-base-content border-base-300 border-t px-10 py-4">
    <aside class="grid-flow-col items-center">
      ...
      <div>
        <p>
          MoodFlow
          <br />
          Ton journal d'humeur intelligent depuis 2024
        </p>
        <!-- Lien admin discret -->
        <RouterLink 
          to="/admin/login" 
          class="text-xs opacity-20 hover:opacity-40 transition-opacity mt-1 inline-block"
    ...
    <nav class="md:place-self-center md:justify-self-end">
      <div class="grid grid-flow-col gap-4">
        <a href="https://twitter.com/moodflow" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="https://youtube.com/moodflow" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="https://facebook.com/moodflow" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
...
<script setup>
// Pas de logique particulière pour le footer
</script>
